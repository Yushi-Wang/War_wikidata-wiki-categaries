# -*- coding: utf-8 -*-
"""
Created on Wed Jan  9 18:40:56 2019
...
try:
    ...
    pass
mergecat_sele_qid_location=pd.read_csv(main_path+'input/mergecat_sele_qid_location_battles.csv')
...
qid_MtCountry=pd.read_csv(material_path+'material/qid_MtCountry.tsv',delimiter='\t')
qid_Subject=pd.read_csv(material_path+'material/qid_Subject.tsv',delimiter='\t')
...
A1_05_03_mapCountry=pd.read_stata(material_path+'material/A1_05_03_mapCountry.dta')
...
A1_05_03_mapContinent=pd.read_stata(material_path+'material/A1_05_03_mapContinent.dta')
...
qid_location_continent_country.to_csv(main_path+'output/qid_location_continent_country_battles.csv', index=False)
