# -*- coding: utf-8 -*-
"""
Created on Wed Jan  9 18:36:11 2019
...
mergecat_sele_qid_time=pd.read_csv(main_path+'input/mergecat_sele_qid_time_battles.csv')
...
selected_qid_time=pd.read_csv(main_path+'input/selected_qid_time_battles.csv') 
...
selected_qid_time_cat_3.to_csv(main_path+'output/selected_qid_time_cat_3_original_still_battles.csv', index=False)
