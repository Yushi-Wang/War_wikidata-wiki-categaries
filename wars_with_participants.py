# -*- coding: utf-8 -*-
"""
Created on Tue Nov 20 21:40:50 2018
This file is for creating sheets of conflicts with their categaries, then we can using the categaries to obtain more information of their time, locations and participants.
@author: Yushi Wang
"""
...
#step1:selection
#1.find the items that have labels of propert "instance of" correlated to wor
